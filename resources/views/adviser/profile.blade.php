...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/adviser/teacher-profile/t-profile.css') }}" />
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="main">
            <div class="box-container">
                <h2 class="admin-profile">Manage Profile</h2>
            </div>
            ...
            <div class="report-container">
                <div class="profile-container">
                    ...
                    <div class="profile-info">
                        ...
                        <p id="position">Adviser</p>
                        <h2>Login Credentials</h2>
                        <p>
                            Username: <span id="username-display">johndoe</span>
                        </p>
                        <p>
    ...
    <script src="{{ asset('js/adviser/teacher-profile/t-profile.js') }}"></script>
</body>
</html>
